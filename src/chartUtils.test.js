...
describe('getChartGradients', () => {
  ...
  it('should have consistent opacity values across themes', () => {
    ...
    // Primary gradients
    expect(darkResult.primary.startOpacity).toBe(lightResult.primary.startOpacity);
    expect(darkResult.primary.endOpacity).toBe(lightResult.primary.endOpacity);

    // Secondary gradients
    expect(darkResult.secondary.startOpacity).toBe(lightResult.secondary.startOpacity);
    expect(darkResult.secondary.endOpacity).toBe(lightResult.secondary.endOpacity);

    // Warning gradients
    expect(darkResult.warning.startOpacity).toBe(lightResult.warning.startOpacity);
...
describe('Chart Utils Integration', () => {
  ...
  it('should return different values for dark vs light mode for all theme-dependent functions', () => {
    ...
    expect(getTooltipCursorStyles(true)).not.toEqual(getTooltipCursorStyles(false));
    ...
    expect(getActiveDotStyles(true, '#fff')).not.toEqual(getActiveDotStyles(false, '#fff'));
