...
describe('AlertItem', () => {
  describe('basic rendering', () => {
    it('should render the alert message', () => {
      ...
      expect(screen.getByText('Temperature warning in enclosure')).toBeInTheDocument();
    });
  ...
  describe('different message content', () => {
    ...
    it('should render message with special characters', () => {
      ...
      renderWithTheme(<AlertItem alert={alert} />);
      expect(screen.getByText('Temperature: 25°C - Alert! <critical>')).toBeInTheDocument();
    });
    ...
    it('should render message with numbers', () => {
      ...
      renderWithTheme(<AlertItem alert={alert} />);
      expect(screen.getByText('Enclosure #42 needs attention - ID: 12345')).toBeInTheDocument();
    });
  });
  ...
  describe('integration tests', () => {
    ...
    it('should maintain consistent styling across theme changes', () => {
      ...
      // Render in dark mode
      const { container: darkContainer } = renderWithTheme(<AlertItem alert={alert} />, {
        darkMode: true,
      });
