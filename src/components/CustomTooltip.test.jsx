...
describe("CustomTooltip", () => {
  describe("basic rendering", () => {
    it("should render when active with payload", () => {
      renderWithTheme(
        <CustomTooltip active={true} payload={defaultPayload} label="Monday" />,
      );
  ...
  describe("label rendering", () => {
    ...
    it("should render empty string label (but element exists)", () => {
      renderWithTheme(
        <CustomTooltip active={true} payload={defaultPayload} label="" />,
      );
    ...
    it("should render numeric label", () => {
      renderWithTheme(
        <CustomTooltip active={true} payload={defaultPayload} label={2024} />,
      );
    ...
    it("should have font-bold class on label", () => {
      renderWithTheme(
        <CustomTooltip active={true} payload={defaultPayload} label="Week 1" />,
      );
  ...
  describe("multiple payload items", () => {
    it("should render all payload items", () => {
      ...
      renderWithTheme(
        <CustomTooltip active={true} payload={multiPayload} label="Monday" />,
      );
  ...
  describe("value formatting", () => {
    it("should format percentage values (dataKey === value)", () => {
      const payload = createPayload([
        { name: "Efficiency", value: 85, dataKey: "value" },
      ]);

      renderWithTheme(
        <CustomTooltip active={true} payload={payload} label="Test" />,
      );
    ...
    it("should not add percentage for non-value dataKeys", () => {
      const payload = createPayload([
        { name: "Animals", value: 150, dataKey: "animals" },
      ]);
    ...
    it("should handle decimal values", () => {
      const payload = createPayload([
        { name: "Temperature", value: 24.5, dataKey: "temp" },
      ]);
    ...
    it("should handle large numbers", () => {
      const payload = createPayload([
        { name: "Population", value: 1000000, dataKey: "pop" },
      ]);
    ...
    it("should handle negative values", () => {
      const payload = createPayload([
        { name: "Change", value: -15, dataKey: "change" },
      ]);
    ...
    it("should handle string values", () => {
      const payload = createPayload([
        { name: "Status", value: "Active", dataKey: "status" },
      ]);
  ...
  describe("payload item styling", () => {
    ...
    it("should apply inline color style from payload", () => {
      const payload = createPayload([
        { name: "Test", value: 100, color: "#ff5500" },
      ]);
  ...
  describe("edge cases", () => {
    ...
    it("should handle special characters in payload name", () => {
      const payload = createPayload([
        { name: "Temperature (°C)", value: 25, color: "#60a5fa" },
      ]);
