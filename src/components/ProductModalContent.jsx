        ...
        <div className="space-y-3">
          <div className={`p-4 rounded-xl ${cardClasses}`}>
            ...
            <p className={`text-sm mt-1 ${textClasses}`} style={{ fontFamily }}>
              Track leads across your pipeline, monitor conversion rates, call activities, and
              meeting schedules with live updates and historical data analysis.
            </p>
          </div>
          <div className={`p-4 rounded-xl ${cardClasses}`}>
            <h5 className={`font-semibold ${headingClasses}`} style={{ fontFamily }}>
            ...
            <p className={`text-sm mt-1 ${textClasses}`} style={{ fontFamily }}>
              Interactive charts, conversion rate metrics, and lead source distribution analysis
              with exportable reports for sales performance reviews.
            </p>
          </div>
          <div className={`p-4 rounded-xl ${cardClasses}`}>
            <h5 className={`font-semibold ${headingClasses}`} style={{ fontFamily }}>
            ...
            <p className={`text-sm mt-1 ${textClasses}`} style={{ fontFamily }}>
              Automated lead monitoring with customizable alerts for follow-up reminders, deal
              updates, meeting schedules, and pipeline milestones.
            </p>
          </div>
        </div>
      </div>
