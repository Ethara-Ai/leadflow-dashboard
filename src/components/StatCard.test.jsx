...
describe('StatCard', () => {
  describe('basic rendering', () => {
    ...
    it('should render without crashing with minimal props', () => {
      renderWithTheme(
        <StatCard title="Test" value="123" icon={<span>Icon</span>} accent="bg-red-500" />
      );
  ...
  describe('subValue and subText rendering', () => {
    ...
    it('should render both subValue and subText together', () => {
      renderWithTheme(<StatCard {...defaultProps} subValue="+8" subText="new arrivals" />);
      expect(screen.getByText('+8')).toBeInTheDocument();
      expect(screen.getByText('new arrivals')).toBeInTheDocument();
    });

    it('should not render subValue element when not provided', () => {
      const { container } = renderWithTheme(<StatCard {...defaultProps} subText="some text" />);
  ...
  describe('subValueVariant styling', () => {
    it('should apply positive (emerald) color class', () => {
      renderWithTheme(<StatCard {...defaultProps} subValue="+10%" subValueVariant="positive" />);
    ...
    it('should apply negative (rose) color class', () => {
      renderWithTheme(<StatCard {...defaultProps} subValue="-5%" subValueVariant="negative" />);
    ...
    it('should apply warning (amber) color class', () => {
      renderWithTheme(<StatCard {...defaultProps} subValue="~3%" subValueVariant="warning" />);
    ...
    it('should apply neutral color for unrecognized variant', () => {
      renderWithTheme(<StatCard {...defaultProps} subValue="test" subValueVariant="unknown" />);
  ...
  describe('edge cases', () => {
    ...
    it('should handle negative values in subValue', () => {
      renderWithTheme(<StatCard {...defaultProps} subValue="-100" subValueVariant="negative" />);
