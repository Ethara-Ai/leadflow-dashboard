...
vi.mock('framer-motion', () => ({
  motion: {
    div: ({ children, className, onClick, role, tabIndex, onKeyDown, ...props }) => (
      <div
        className={className}
        onClick={onClick}
        role={role}
...
describe('Header', () => {
  ...
  describe('basic rendering', () => {
    ...
    it('should render the tagline', () => {
      renderWithTheme(<Header {...defaultProps} />);
      expect(screen.getByText('Lead generation and management platform')).toBeInTheDocument();
    });
  ...
  describe('refresh button', () => {
    ...
    it('should show spinning animation when loading', () => {
      const { container } = renderWithTheme(<Header {...defaultProps} isLoading={true} />);
